...
def load_cre_graph(path_cre_attributes, path_dna, path_edges, config_path):
...
def load_graph_data(path_directory, dataset_name, config_path):
    ...
    if(dataset_name == "cre"):
        ...
        return load_cre_graph(path_cre_attributes, path_dna, path_edge, config_path)